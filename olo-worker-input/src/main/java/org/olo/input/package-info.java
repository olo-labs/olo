 ...
 *   <li>{@link org.olo.input.consumer} – read-only contract ({@link org.olo.input.consumer.WorkflowInputValues}) and resolution (DefaultWorkflowInputValues, CacheReader, FileReader)</li>
